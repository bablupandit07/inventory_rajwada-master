...
@section('content')
    ...
    <fieldset class="mt-2">
        ...
        <div class="card">
            ...
            @endif --}}
            <form action="{{ url('admin/master/party_master') }}" method="post">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-2">
                            <label for="">Party Name <span class="text-danger fw-bold">*</span></label>
...
@endisset
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            @endisset
                            <a href="{{ url('admin/master/party_master') }}" class="btn btn-danger btn-sm"> Reset </a>
                                ...
                                @foreach ($allData as $data)
                                    <tr id="pid{{ $data->id }}">
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('admin/master/party_master/edit/' . $data->id) }}"
